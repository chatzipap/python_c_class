...
συμβολοσειρά substring περιέχεται στην συμβολοσειρά string και αν ναι, θα
επιστρέφει True. Στη συνέχεια να χρησιμοποιήσετε αυτή τη συνάρτηση, για να βρείτε
